 ...
 */
package OpenShiftTest.OpenShiftTest.rest;
...
@Path("/temp")
@RequestScoped
public class TemperatureResourceRestService {
    ...
    @GET
    @Path("/tempData/{id:[0-9][0-9]*}")
    @Produces(MediaType.APPLICATION_JSON)
    public List<TempData> getTempData(@PathParam("id") long id) {
        return temperatureService.getTempData(id);        
    }
    ...
    public Set<Long> listSensor() {
        return temperatureService.listSensor();
    }
